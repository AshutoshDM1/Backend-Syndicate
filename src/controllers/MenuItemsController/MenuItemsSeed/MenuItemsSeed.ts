  ...
  await prisma.modifier.createMany({
    data: [
      ...
      // Salmon modifiers
      {
        ...
        price: 0.5,
        type: ModifierType.EXTRA,
        description: 'Add extra lemon slices',
      },
      {
        id: 'mod-4',
        name: 'Medium Rare',
        price: 0,
        type: ModifierType.OPTION,
        description: 'Cook to medium rare',
      },
      ...
      },
      {
        ...
        price: 0,
        type: ModifierType.OPTION,
        description: 'Serve dressing on the side',
      },
      ...
      // Dessert modifiers
      {
        ...
        price: 2.0,
        type: ModifierType.EXTRA,
        description: 'Add vanilla ice cream',
      },
      {
        id: 'mod-10',
        name: 'Extra Hot',
      ...
      // Burger modifiers
      {
        ...
        price: 4.0,
        type: ModifierType.EXTRA,
        description: 'Add extra beef patty',
      },
      {
        id: 'mod-12',
        name: 'No Onions',
      ...
      },
      {
        ...
        price: 1.0,
        type: ModifierType.OPTION,
        description: 'Use gluten-free pasta',
      },
      ...
      },
      {
        ...
        price: 0,
        type: ModifierType.OPTION,
        description: 'Add spicy seasoning',
      },
      ...
      // Smoothie modifiers
      {
        ...
        price: 2.0,
        type: ModifierType.EXTRA,
        description: 'Add protein powder',
      },
      {
        id: 'mod-20',
        name: 'Extra Large',
        price: 2.0,
        type: ModifierType.OPTION,
        description: 'Make it extra large',
      },
    ],
    skipDuplicates: true,
  });
  ...
  await prisma.comboMeal.createMany({
    data: [
      ...
      },
      {
        ...
        price: 22.5,
        image:
          'https://images.unsplash.com/photo-1671898295493-b8a75407dadb?w=500&auto=format&fit=crop',
        isAvailable: true,
      },
    ],
    skipDuplicates: true,
